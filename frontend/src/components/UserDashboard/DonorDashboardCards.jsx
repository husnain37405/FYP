...
//                 <Card.Text style={{marginLeft:'0'}}>Total Donations: {totalDonationsCount?.totalDonationsCount || 0}</Card.Text>
//               </Card.Body>
//             </Card>
//           </Col>
...
//                 <Card.Text style={{marginLeft:'0'}}>Total Donated Amount: 
...
import React, { useState, useEffect } from 'react';
import { Card, Row, Col, Modal, Button } from 'react-bootstrap';
import { FaHandsHelping, FaDollarSign, FaCalendarAlt } from 'react-icons/fa';
import Calendar from 'react-calendar';
import 'react-calendar/dist/Calendar.css';
import './DashboardCards.css';
import { useGetUserDetailsQuery } from '../../redux/features/user/userApi';
